...
---------------------------
SELECT DISTINCT f.FeatureName, cfv.ValueString[Characteristic Desc], cfv2.ValueString[Tool/Tolernace], cfv3.ValueString[Frequency], cfv4.ValueString[Insp Method]
...
WHERE r.RunName = ? AND rt.RoutineName = ?
	...
	AND cfv3.CustomFieldID = 12 AND cfv4.CustomFieldID = 11
