SELECT jh.JobNum, jh.Company, jh.PartNum, jh.RevisionNum, jo.Character01, pr.Character01, LEFT(rs.Description,LEN(rs.Description)-11)[Machine], rs.cell_c, jh.PartDescription, jo.QtyCompleted, jh.DrawNum 
