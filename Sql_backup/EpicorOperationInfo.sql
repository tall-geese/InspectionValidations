...
LEFT OUTER JOIN EpicorLive11.dbo.JobOper jo ON jo.JobNum = jh.JobNum 
LEFT OUTER JOIN EpicorLive11.dbo.JobOpDtl jdt ON jo.JobNum = jdt.JobNum AND jo.OprSeq = jdt.OprSeq 
INNER JOIN EpicorLive11.dbo.Resource rs ON jdt.ResourceID = rs.ResourceID 
